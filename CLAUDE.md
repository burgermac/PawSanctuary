...
| `specs/Spec_Phase6b_RewardLadder.md` | Phase 6b — D8 ("chain offer," renamed to avoid colliding with this codebase's own merge-chain vocabulary). Draft, written cold 18 Aug 2026; trigger (permanent, untimed) and UI placement (Shop section + task-strip teaser) both resolved 18 Aug 2026, only §4 numbers still open; not implemented. |
