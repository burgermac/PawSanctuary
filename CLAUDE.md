...
| `specs/Spec_Phase6b_RewardLadder.md` | Phase 6b — D8 ("chain offer," renamed to avoid colliding with this codebase's own merge-chain vocabulary). Draft, written cold 18 Aug 2026, not yet design-authority-reviewed; not implemented. |
