...
| `specs/Spec_Phase6b_RewardLadder.md` | Phase 6b — D8 ("chain offer," renamed to avoid colliding with this codebase's own merge-chain vocabulary). Written cold 18 Aug 2026; design-authority reviewed and confirmed 18 Aug 2026 (trigger, UI placement, §4 numbers); ready to implement, not yet implemented. |
