...
| `specs/Spec_Phase6b_RewardLadder.md` | Phase 6b — D8 ("chain offer," renamed to avoid colliding with this codebase's own merge-chain vocabulary). Written cold and design-reviewed 18 Aug 2026. Tasks 3.1–3.5 all implemented and tested (393/393) — IAP + purchase logic, persistence, trigger gate, Shop + task-strip UI, real 6-rung registry content. On-screen verification still open (see `TODO.md`) — no debug lever yet reaches `isMonetizationUnlocked` faster than real play. |
