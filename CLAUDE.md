...
| `specs/Spec_Phase6b_RewardLadder.md` | Phase 6b — D8 ("chain offer," renamed to avoid colliding with this codebase's own merge-chain vocabulary). Written cold and design-reviewed 18 Aug 2026. Tasks 3.1–3.4 implemented (IAP + purchase logic, persistence confirmed, trigger gate, Shop section + task-strip UI); 3.5 (real registry content) still open — the ladder has nothing to render until then. |
