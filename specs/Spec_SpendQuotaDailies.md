...
- **Standing-quest (`Quest`) spend goals** — confirmed out of scope (§2/§6); real, separate follow-up work if ever wanted, not a cheap extension. Revisited the same day — see `specs/Spec_StandingQuestSpendGoals.md` (written cold, not yet design-authority-reviewed).
